...
class ChessUI(Bindings):
    ...
    def _create_partial_position_row(self):
        """Raise ChessUIError excption.

        Subclasses should override and return a ChessDBrowCQL instance.
        """
        raise ChessUIError(
            "Override this method and return a ChessDBrowCQL instance"
        )
    ...
    def _create_tag_roster_grid(self):
        """Subclass must override and return a TagRosterGrid instance."""
        raise ChessUIError(
            "".join(
                (
                    "Use a subclass which overrides this method and ",
                    "returns a TagRosterGrid instance",
                )
            )
        )

    def _create_game_position_games_grid(self):
        """Return GamePositionGames instance - exists to be overridden."""
        raise ChessUIError(
            "".join(
                (
                    "Use a subclass which overrides this method and ",
                    "returns a GamePositionGames instance",
                )
            )
        )

    def _create_partial_position_games_grid(self):
        """Subclass must override and return PartialPositionGames instance."""
        raise ChessUIError(
            "".join(
                (
                    "Use a subclass which overrides this method and ",
                    "returns a PartialPositionGames instance",
                )
            )
        )

    def _create_cql_grid(self):
        """Subclass must override and return a CQLGrid instance."""
        raise ChessUIError(
            "".join(
                (
                    "Use a subclass which overrides this method and ",
                    "returns a CQLGrid instance",
                )
            )
        )
