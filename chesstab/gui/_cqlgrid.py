...
class CQLListGrid(AllGrid, CQLGameListQuery, DataGrid, Display):
    ...
    def make_display_widget(self, sourceobject):
        """Subclass must override and return a CQLDisplay instance."""
        raise CQLGridError(
            "".join(
                (
                    "Use a subclass which overrides this method and ",
                    "returns a CQLDisplay instance",
                )
            )
        )
    ...
    def make_edit_widget(self, sourceobject):
        """Subclass must override and return a CQLUpdate instance."""
        raise CQLGridError(
            "".join(
                (
                    "Use a subclass which overrides this method and ",
                    "returns a CQLUpdate instance",
                )
            )
        )
