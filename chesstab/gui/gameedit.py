...
class GameEdit(Game):
    ...
    def delete_forced_newline_token_prefix(self, tag, range_):
        ...
        if fnltpr or fnltnr:
            ...
            nr_q = fnltnr[0]
            for ti_q in tr_q:
                if widget.compare(ti_q, ">", pr_q) and widget.compare(ti_q, "<", nr_q):
                    tri += 1
    ...
    def get_nearest_move_to_token(self, token):
        ...
        while r_q:
            ...
            r_q = widget.tag_prevrange(NAVIGATE_TOKEN, r_q[0], START_SCORE_MARK)
    ...
    def step_one_variation_select(self, move):
        ...
        if move is None:
            ...
            pt_q = None
            ct_q = self.get_choice_tag_of_move(self.select_first_move_of_game())
